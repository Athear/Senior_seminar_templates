...
\begin{frame}
  ...
  \begin{itemize}
	...
	\item A language might not have an analogous structure %need example. is there a language without maps?
	\item 
	\item 
	\item 
  \end{itemize}
  ...
  %It does have the building blocks for creating maps, and this will usually be the case. But 
