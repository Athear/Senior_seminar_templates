...
\begin{frame}
  ...
  \begin{column}{0.6\textwidth}
  \begin{itemize}
  	\item Interop can make system design simpler by allowing programmers to use otherwise incompatible languages.
  	\item Interop gives programmers 
	\item Metadata and standards are core concepts that can make interop possilbe.
	\item Virtual machines and markup languages make use of these concepts to enable interop in ways.
	\item 
	\item 
  \end{itemize}
  \end{column}
