...
\begin{frame}
  ...
  \begin{itemize}
  	\item Interop allows programmers to not have to worry about what language existing systems are written in.
  	\item Also allows programmers access to the strengths of languages other than the main system language.
	\item Metadata and standards allow programmers to reason about interop, and to communicate how their system 
