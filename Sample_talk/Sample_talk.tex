...
\begin{frame}
  ...
  \begin{column}{0.6\textwidth}
  \begin{itemize}
  	\item Third-party or legacy systems %where source code is unavailable
...
\section[Difficulties and Approaches]{Issues encountered in Interop and approaches to dealing with them}
