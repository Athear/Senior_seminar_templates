...
However, interoperability is important to many existing systems today, 
 as programming languages have evolved to target particular problem domains. In cases where 
 at the expense of performance in others or in ease of use.
 In particular, the domains of client/server architecture and many distributed computing systems utilize multiple languages for network communication.
