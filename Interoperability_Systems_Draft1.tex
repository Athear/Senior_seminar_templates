...
JIT comilation is a runtime optimization method where frequently used portions of a program are compiled to machine language for quick use, while the remaining code is interpreted as normal. 
